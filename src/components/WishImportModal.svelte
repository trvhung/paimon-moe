    ...
    {#if showFaq}
      ...
      <div class="font-body">
        ...
        <p class="text-gray-400">
          ...
          <a class="text-primary hover:underline" target="_blank" rel="nofollow" href="https://gamehot.net"
            >Github</a
        ...
        <p class="text-gray-400">
          ...
          <a class="text-primary hover:underline" href="https://gamehot.net" rel="nofollow" target="_blank"
